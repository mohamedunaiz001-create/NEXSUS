...
const PRESET_TEMPLATES = [
  {
    title: 'LockBit 3.0 Ransomware Binary Ingress',
    category: 'Malware & Payload Execution',
    severity: 'Critical',
    description: 'Obfuscated PE64 dropper detonated in accounting workstation. Initiated volume shadow deletion and XOR payload unpacking.',
    tags: ['Ransomware', 'Binary Disassembly', 'PE64', 'C2 Dropper'],
    iocCount: 24
  },
  {
    title: 'Covert DNS Tunneling & C2 Beaconing',
    category: 'Network Anomaly & Exfiltration',
    severity: 'High',
    description: 'Sustained TXT record requests over UDP 53 to unknown external nameserver carrying encrypted staging telemetry.',
    tags: ['PCAP', 'DNS Tunneling', 'Beacon Detection', 'Netflow'],
    iocCount: 42
  },
  {
    title: 'Kerberoasting & AD Privilege Escalation Script',
    category: 'Code Review & Exploit Vulnerability',
    severity: 'High',
    description: 'Suspicious PowerShell script executing Invoke-Kerberoast targeting SPN ticket extraction on Domain Controller.',
    tags: ['PowerShell', 'AST Parsing', 'CVE-2023-38831', 'Privilege Escalation'],
    iocCount: 6
  },
  {
    title: 'Targeted Spear-Phishing Campaign (APT28)',
    category: 'Threat Intelligence & APT Attribution',
    severity: 'Medium',
    description: 'Phishing domain clone mimicking SSO login portal with reverse proxy credential harvesting tied to Fancy Bear infrastructure.',
    tags: ['APT28', 'Adversary Attribution', 'VirusTotal OTX', 'Phishing'],
    iocCount: 15
  },
  {
    title: 'Cryptominer Memory Injection Anomaly',
    category: 'Memory & Host Telemetry',
    severity: 'Medium',
    description: 'Reflective DLL injection detected inside svchost.exe utilizing 90% CPU on cloud worker node.',
    tags: ['Memory Forensics', 'DLL Injection', 'Volatile Artifacts', 'Process Hollowing'],
    iocCount: 8
  }
];
