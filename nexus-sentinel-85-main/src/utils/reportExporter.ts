...
<body>
  ...
  <div class="forensic-grid">
    <div class="forensic-card">
      ...
      malware.exe (PE32+ Executable, 1.42 MB)
    </div>
    <div class="forensic-card">
    ...
    <div class="forensic-card">
      ...
      WS-PROD-FIN-09.corp.internal (10.142.88.45)
    </div>
    <div class="forensic-card">
      <strong>YARA Signature Match</strong>
      RULE_APT28_GOST_LOADER (99.4% Confidence Match)
    </div>
  </div>
...
<body>
  ...
  <table>
    ...
    <tr>
      ...
      <td>malware.exe (1.42 MB, PE32+ GUI)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>WS-PROD-FIN-09.corp.internal (10.142.88.45)</td>
    </tr>
    <tr>
      <td><strong>Entropy:</strong></td>
      <td>7.94 (High Entropy, Packed binary detected)</td>
    </tr>
    <tr>
      <td><strong>YARA Match Rule:</strong></td>
      <td>RULE_APT28_GOST_LOADER (99.4% Match Score)</td>
    </tr>
  </table>
