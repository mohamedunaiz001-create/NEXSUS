          ...
          <div className="relative" ref={moreMenuRef}>
            ...
            {isMoreMenuOpen && moreMenuPos && createPortal(
              <div 
                ...
                className="w-64 rounded-xl bg-[#0c051f] border border-purple-500/40 shadow-2xl p-1.5 z-[999] space-y-1 font-mono text-xs backdrop-blur-xl animate-in fade-in"
