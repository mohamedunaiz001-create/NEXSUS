...
export const CEOCommander: React.FC<CEOCommanderProps> = ({ ceo, onOpenChat, onUpdateCeo, agents = [], onSelectAgent }) => {
  // Dropdown states
  ...
  // Live roster of specialists the CEO is actively directing — used to give
  // the broadcast action real context about current fleet load.
